...
const SERVICES = [
  ...
  { icon: "FileText",  title: "Оплата импорта и приём экспортной выручки",  desc: "Организация оплаты импортных поставок и зачисление экспортной выручки. Работа с любыми валютами, странами и схемами расчётов. Полное юридическое и документальное сопровождение.", price: "от 3 000 ₽" },
];
